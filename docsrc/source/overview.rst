...
as the JAX substrate in TFP matures. For now, the flattening is done by hand in the JAX implementation.
Similarly, the VI for JAX is implemented within the ``gigalens`` package, whereas in the TensorFlow implementation,
